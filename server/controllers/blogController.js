...
export const generateContent = async (req, res) => {
  try {
    ...
    const content = await main(
      prompt +
        "Generate a blog content for this topic in simple text format without mentioning: Here's blog content about the importance of friendship, in a simple text format:"
    );
    res.json({
      success: true,
      content,
