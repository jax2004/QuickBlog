...
const AddBlog = () => {
  ...
  return (
    <form
      ...
      className="flex-1 bg-blue-50 text-gray-600 h-full overflow-hidden"
    >
      <div className="bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded">
        ...
        <div className="max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative">
          ...
          {loading && (
            <div className="absolute right-0 top-0 bottom-0 left-0 flex items-center justify-center bg-black/10 mt-2">
              <div className="w-8 h-8 rounded-b-full border border-t-white animate-spin"></div>
            </div>
          )}
          <button
            type="button"
        ...
        <select
          ...
          className="mt-2 px-3 py-2 text-gray-500 border border-gray-300 rounded"
          name="category"
        >
