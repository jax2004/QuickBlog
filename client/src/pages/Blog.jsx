  ...
  return data ? (
    <div className="relative">
      ...
      <div className="text-center mt-20 text-gray-600">
        ...
        ></h2>
        <p className="inline-block py-1 px-4 rounded-full mb-6 border text-sm border-primary/35 bg-primary/5 font-medium text-blue-600">
          Michael Brown
        </p>
      </div>

      <div className="mx-5 max-w-5xl md:mx-auto my-10 mt-6">
        <img className="rounded-4xl" src={data.image} alt="" />
        <div
          className="rich-text max-w-3xl mx-auto mt-4"
        ...
        <div className="mt-14 mb-10 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col gap-4">
            {comment.map((item, index) => (
              <div
                className="relative bg-primary/2 border border-blue-600 max-w-xl p-4 rounded text-gray-600 "
                key={index}
              >
